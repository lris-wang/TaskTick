...
export const COLOR_SCHEMES: ColorScheme[] = [
  ...
  },
  {
    ...
    dark: {
      ...
      rowBg: "linear-gradient(145deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.02) 100%)",
      rowHoverBg: "rgba(255, 255, 255, 0.06)",
      rowHoverBorder: "rgba(96, 165, 250, 0.35)",
    ...
    light: {
      sidebarBg: "linear-gradient(160deg, #e0f2fe 0%, #bae6fd 100%)",
      sidebarBorder: "rgba(14, 165, 233, 0.2)",
      sidebarText: "#0c4a6e",
      sidebarTextMuted: "#38bdf8",
      ...
      subtleBg: "rgba(0, 0, 0, 0.03)",
      subtleBorder: "rgba(0, 0, 0, 0.08)",
      hoverBorder: "rgba(2, 132, 199, 0.4)",
      rowBorder: "rgba(0, 0, 0, 0.1)",
      rowBg: "linear-gradient(145deg, rgba(255, 255, 255, 0.96) 0%, rgba(255, 255, 255, 0.88) 100%)",
      rowHoverBg: "rgba(0, 0, 0, 0.04)",
      rowHoverBorder: "rgba(2, 132, 199, 0.35)",
  ...
  },
  {
    ...
    dark: {
      ...
      rowBg: "linear-gradient(145deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.02) 100%)",
      rowHoverBg: "rgba(255, 255, 255, 0.06)",
      rowHoverBorder: "rgba(74, 222, 128, 0.35)",
    ...
    light: {
      sidebarBg: "linear-gradient(160deg, #ecfdf5 0%, #d1fae5 100%)",
      ...
      rowBg: "linear-gradient(145deg, rgba(255, 255, 255, 0.96) 0%, rgba(255, 255, 255, 0.88) 100%)",
      rowHoverBg: "rgba(0, 0, 0, 0.04)",
      rowHoverBorder: "rgba(5, 150, 105, 0.35)",
  ...
  },
  {
    ...
    dark: {
      ...
      rowBg: "linear-gradient(145deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.02) 100%)",
      rowHoverBg: "rgba(255, 255, 255, 0.06)",
      rowHoverBorder: "rgba(244, 114, 182, 0.35)",
    ...
    light: {
      sidebarBg: "linear-gradient(160deg, #fdf2f8 0%, #fce7f3 100%)",
      sidebarBorder: "rgba(219, 39, 119, 0.2)",
      sidebarText: "#831843",
      sidebarTextMuted: "#f472b6",
      sidebarActiveBg: "rgba(219, 39, 119, 0.15)",
      sidebarActiveText: "#db2777",
      appBg: "#fdf2f8",
      cardBg: "#ffffff",
      accent: "#db2777",
      accentHover: "#ec4899",
      ...
      subtleBg: "rgba(0, 0, 0, 0.03)",
      subtleBorder: "rgba(0, 0, 0, 0.08)",
      hoverBorder: "rgba(219, 39, 119, 0.4)",
      rowBorder: "rgba(0, 0, 0, 0.1)",
      rowBg: "linear-gradient(145deg, rgba(255, 255, 255, 0.96) 0%, rgba(255, 255, 255, 0.88) 100%)",
      rowHoverBg: "rgba(0, 0, 0, 0.04)",
      rowHoverBorder: "rgba(219, 39, 119, 0.35)",
